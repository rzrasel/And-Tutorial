...
public class FusedLocationWithSettingsDialog implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback<LocationSettingsResult> {
    ...
    protected void onStart(Context argContext) {
        context = argContext;
        ...
        if (resultCode == ConnectionResult.SUCCESS) {
            ...
            googleAPI.getErrorDialog((Activity) context, resultCode, RQS_GooglePlayServices);
        }
    }
    ...
    public void goAndDetectLocation() {
        ...
        hasFineLocationPermission = ActivityCompat.checkSelfPermission(context, android.Manifest.permission.ACCESS_FINE_LOCATION);
        hasCoarseLocationPermission = ActivityCompat.checkSelfPermission(context, android.Manifest.permission.ACCESS_COARSE_LOCATION);
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    Toast.makeText(context, "Location dialog will be open", Toast.LENGTH_SHORT).show();
                    //
