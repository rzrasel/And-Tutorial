...
public class CleanableAutoCompleteTextView extends android.support.v7.widget.AppCompatAutoCompleteTextView {
    ...
    private OnClearListener defaultClearListener = new OnClearListener() {
        ...
        @Override
        public void onClear() {
            CleanableAutoCompleteTextView et = CleanableAutoCompleteTextView.this;
            et.setText("");
        }
    };
    ...
    public Drawable imgClearButton = getResources().getDrawable(R.drawable.libs_clear_icon);
...
/*
https://stackoverflow.com/questions/31636591/how-can-i-create-clean-button-in-autocompletetextview
https://www.drzon.net/posts/how-to-create-a-clearable-autocomplete-dropdown-with-autocompletetextview/
*/