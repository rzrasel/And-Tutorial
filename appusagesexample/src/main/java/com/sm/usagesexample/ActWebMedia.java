...
public class ActWebMedia extends AppCompatActivity {
    private Activity activity;
    private Context context;
    private WebView sysWebViewPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_web_media);
        activity = this;
        context = this;
        //sysWebViewPlayer = (WebView) findViewById(R.id.sysWebViewPlayer);
        /*WebSettings webViewSettings = sysWebViewPlayer.getSettings();
        webViewSettings.setJavaScriptEnabled(true);
        webViewSettings.setJavaScriptCanOpenWindowsAutomatically(true);
        webViewSettings.setJavaScriptEnabled(true);
        if (Build.VERSION.SDK_INT < 8) {
            //sysWebViewPlayer.getSettings().setPluginsEnabled(true);
        } else {
        ...
        sysWebViewPlayer.setWebViewClient(new WebViewClient() {
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                return false;
            }
        });

        sysWebViewPlayer.loadData("<iframe src=\"http://mixlr.com/enikaasradio/embed/?autoplay=true\"></iframe>", "text/html", "utf-8");*/
        ...
        //youtubePlayerView.initializeWithCustomURL("http://www.dhakasports.com/embed/gtv.php", params, new YoutubePlayerView.YouTubeListener() {
        youtubePlayerView.initializeWithCustomURL("http://c247.to/live.php?ch=Ten_Sports&amp;vw=670&amp;vh=440&amp;domain=dhakasports.com", params, new YoutubePlayerView.YouTubeListener() {
