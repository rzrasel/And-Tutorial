...
public class DeviceIPApi {
    ...
    public String getApparentIPAddress(OnEventListenerHandler argOnEventListenerHandler) {
        String actualIPAddress = null;
    ...
    public String getMacAddressOld(Context argContext) {
        WifiManager wimanager = (WifiManager) argContext.getSystemService(Context.WIFI_SERVICE);
    ...
    //http://www.ip-api.com/json 209.126.90.249, 66.249.88.63
