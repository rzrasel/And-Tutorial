...
final class C0846o {
    ...
    public final void m2453a(long j, double d, double d2) {
        ...
        if (sin >= 1.0d) {
            ...
            this.f2558b = Math.round((((double) acos) + sin2) * 8.64E7d) + 946728000000L;
            this.f2559c = Math.round((sin2 - ((double) acos)) * 8.64E7d) + 946728000000L;
            if (this.f2559c >= j || this.f2558b <= j) {
                this.f2560d = 1;
            } else {
                this.f2560d = 0;
            }
