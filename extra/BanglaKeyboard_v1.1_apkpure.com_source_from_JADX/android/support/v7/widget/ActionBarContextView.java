...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0770a.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0779j.ActionMode, i, 0);
        C0679r.m1912a((View) this, obtainStyledAttributes.getDrawable(C0779j.ActionMode_background));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(C0779j.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(C0779j.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(C0779j.ActionMode_height, 0);
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0779j.ActionMode_closeItemLayout, C0776g.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0776g.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0775f.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0775f.action_bar_subtitle);
    ...
    public void initForMode(final C0852b c0852b) {
        if (this.mClose == null) {
        ...
        this.mClose.findViewById(C0775f.action_mode_close_button).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                c0852b.mo834c();
            }
        });
        C0131h c0131h = (C0131h) c0852b.mo831b();
        ...
        c0131h.m253a(this.mActionMenuPresenter, this.mPopupContext);
        this.mMenuView = (ActionMenuView) this.mActionMenuPresenter.getMenuView(this);
        C0679r.m1912a(this.mMenuView, null);
    ...
    public /* bridge */ /* synthetic */ C0693v setupAnimatorToVisibility(int i, long j) {
