...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        if (this.mWrapped.hasValue(i)) {
            ...
            if (resourceId != 0) {
                ColorStateList a = C0862b.m2513a(this.mContext, resourceId);
                if (a != null) {
                    return a;
                }
            }
    ...
    public Drawable getDrawable(int i) {
        if (this.mWrapped.hasValue(i)) {
            int resourceId = this.mWrapped.getResourceId(i, 0);
            if (resourceId != 0) {
                return C0862b.m2514b(this.mContext, resourceId);
            }
        }
    ...
    public Typeface getFont(int i, int i2, TextView textView) {
        ...
        Typeface a = C0437b.m1155a(context, resources, typedValue, resourceId, i2, textView);
        if (a != null) {
            return a;
        }
        throw new NotFoundException("Font resource ID #0x" + Integer.toHexString(resourceId));
    }
