...
import android.support.v4.widget.C0758k;
...
class SuggestionsAdapter extends C0758k implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0775f.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0770a.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            checkIconCache = C0392a.getDrawable(this.mProviderContext, parseInt);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0775f.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
