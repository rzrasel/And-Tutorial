...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected C0693v mVisibilityAnim;
    ...
    protected class VisibilityAnimListener implements C0691w {
        ...
        public VisibilityAnimListener withFinalVisibility(C0693v c0693v, int i) {
            AbsActionBarView.this.mVisibilityAnim = c0693v;
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0770a.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void animateToVisibility(int i) {
        setupAnimatorToVisibility(i, 200).m1989b();
    }
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0779j.ActionBar, C0770a.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0779j.ActionBar_height, 0));
    ...
    public void setVisibility(int i) {
        if (i != getVisibility()) {
            if (this.mVisibilityAnim != null) {
                this.mVisibilityAnim.m1987a();
            }
            super.setVisibility(i);
        }
    }

    public C0693v setupAnimatorToVisibility(int i, long j) {
        if (this.mVisibilityAnim != null) {
            this.mVisibilityAnim.m1987a();
        }
        if (i == 0) {
            ...
            C0693v a = C0679r.m1939l(this).m1983a(1.0f);
            a.m1984a(j);
            a.m1985a(this.mVisAnimListener.withFinalVisibility(a, i));
            return a;
        }
        a = C0679r.m1939l(this).m1983a(0.0f);
        a.m1984a(j);
        a.m1985a(this.mVisAnimListener.withFinalVisibility(a, i));
        return a;
    }
