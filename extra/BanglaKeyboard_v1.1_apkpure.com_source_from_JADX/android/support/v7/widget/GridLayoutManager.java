...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void measureChild(View view, int i, boolean z) {
        ...
        if (this.mOrientation == 1) {
            spaceForSpanRange = LayoutManager.getChildMeasureSpec(spaceForSpanRange, i, i3, layoutParams.width, DEBUG);
            ...
            int childMeasureSpec2 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, i, i2, layoutParams.height, DEBUG);
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        for (i3 = 0; i3 < i2; i3++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i5) {
                ...
                if (this.mOrientation == 1) {
                    spanSize = LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, spanSize, layoutParams.width, DEBUG);
                    i4 = MeasureSpec.makeMeasureSpec(i5 - i6, 1073741824);
                } else {
                    spanSize = MeasureSpec.makeMeasureSpec(i5 - spanSize, 1073741824);
                    i4 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i6, layoutParams.height, DEBUG);
                }
        ...
        while (i10 != i5) {
            ...
            if (!childAt.hasFocusable() || childCount == spanGroupIndex) {
                ...
                if (!(childAt.hasFocusable() && view2 == null) && (childAt.hasFocusable() || view3 != null)) {
                    ...
                    } else if (view2 == null && isViewPartiallyVisible(childAt, DEBUG, true)) {
                        if (min2 > i9) {
                            obj2 = 1;
                        } else if (min2 == i9) {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0626b c0626b) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            if (this.mOrientation == 0) {
                ...
                c0626b.m1688a(C0625l.m1681a(spanIndex, spanSize, spanGroupIndex, 1, z, DEBUG));
                return;
            }
            ...
            c0626b.m1688a(C0625l.m1681a(spanGroupIndex, 1, spanIndex2, spanSize2, z2, DEBUG));
            return;
        }
        super.onInitializeAccessibilityNodeInfoForItem(view, c0626b);
    }
