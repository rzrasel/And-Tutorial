...
final class GapWorker implements Runnable {
    ...
    static Comparator<Task> sTaskComparator = new C10131();
    long mFrameIntervalNs;
    long mPostTimeNs;
    ArrayList<RecyclerView> mRecyclerViews = new ArrayList();
    private ArrayList<Task> mTasks = new ArrayList();

    static class C10131 implements Comparator<Task> {
        C10131() {
        }
    ...
    private void prefetchInnerRecyclerViewWithDeadline(RecyclerView recyclerView, long j) {
        if (recyclerView != null) {
            ...
            if (layoutPrefetchRegistryImpl.mCount != 0) {
                try {
                    C0588b.m1561a("RV Nested Prefetch");
