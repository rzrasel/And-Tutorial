...
import android.support.v4.os.C0588b;
import android.support.v4.view.AbsSavedState;
import android.support.v4.view.C0125i;
import android.support.v4.view.C0665j;
import android.support.v4.view.C0679r;
import android.support.v4.view.C0680s;
import android.support.v4.view.p019a.C0613a;
import android.support.v4.view.p019a.C0626b;
import android.support.v4.view.p019a.C0626b.C0624k;
import android.support.v4.view.p019a.C0626b.C0625l;
import android.support.v4.widget.C0747g;
import android.support.v7.p026f.C0881a.C0878a;
import android.support.v7.p026f.C0881a.C0880c;
...
public class RecyclerView extends ViewGroup implements C0125i {
    ...
    static final Interpolator sQuinticInterpolator = new C10363();
    ...
    private C0665j mScrollingChildHelper;
    final State mState;
    ...
    public static abstract class ViewHolder {
        ...
        private boolean doesTransientStatePreventRecycling() {
            return (this.mFlags & 16) == 0 && C0679r.m1927b(this.itemView);
        }

        private void onEnteredHiddenState(RecyclerView recyclerView) {
            this.mWasImportantForAccessibilityBeforeHidden = C0679r.m1930d(this.itemView);
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            C0588b.m1561a(RecyclerView.TRACE_BIND_VIEW_TAG);
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            C0588b.m1561a(RecyclerView.TRACE_CREATE_VIEW_TAG);
    ...
    public static abstract class ItemAnimator {
        ...
        static int buildAdapterChangeFlagsForAnimations(ViewHolder viewHolder) {
            ...
            return (oldPosition == -1 || adapterPosition == -1 || oldPosition == adapterPosition) ? access$1600 : access$1600 | FLAG_MOVED;
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C10401();
        ...
        private final Callback mVerticalBoundCheckCallback = new C10412();
        private int mWidth;
        ...
        class C10412 implements Callback {
            C10412() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0880c.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0880c.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0880c.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0880c.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0880c.RecyclerView_stackFromEnd, false);
        ...
        public int getLayoutDirection() {
            return C0679r.m1932e(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return C0679r.m1938k(this.mRecyclerView);
        }

        public int getMinimumWidth() {
            return C0679r.m1937j(this.mRecyclerView);
        }
        ...
        public int getPaddingEnd() {
            return this.mRecyclerView != null ? C0679r.m1936i(this.mRecyclerView) : 0;
        }
        ...
        public int getPaddingStart() {
            return this.mRecyclerView != null ? C0679r.m1935h(this.mRecyclerView) : 0;
        }
        ...
        void onInitializeAccessibilityNodeInfo(C0626b c0626b) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, c0626b);
        }

        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, C0626b c0626b) {
            ...
            C0626b.f1916a.mo600a(c0626b.f1917b, new C0624k(C0626b.f1916a.mo599a(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state))).f1914a);
        }

        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0626b c0626b) {
            c0626b.m1688a(C0625l.m1681a(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false, false));
        }

        void onInitializeAccessibilityNodeInfoForItem(View view, C0626b c0626b) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, view, c0626b);
            }
        }
        ...
        public void postOnAnimation(Runnable runnable) {
            if (this.mRecyclerView != null) {
                C0679r.m1916a(this.mRecyclerView, runnable);
            }
        }
    ...
    class C10352 implements Runnable {
        C10352() {
        }
    ...
    static class C10363 implements Interpolator {
        C10363() {
        }
    ...
    class C10374 implements ProcessCallback {
        C10374() {
        }
    ...
    class C10385 implements Callback {
        C10385() {
        }
    ...
    class C10396 implements Callback {
        C10396() {
        }
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                View view = viewHolder.itemView;
                if (C0679r.m1930d(view) == 0) {
                    C0679r.m1906a(view, 1);
                }
                if (!C0679r.m1921a(view)) {
                    viewHolder.addFlags(16384);
                    C0679r.m1913a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
        ...
        final void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z) {
            ...
            if (viewHolder.hasAnyOfTheFlags(16384)) {
                ...
                C0679r.m1913a(viewHolder.itemView, null);
            }
            if (z) {
        ...
        final ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (z4 && !RecyclerView.this.mState.isPreLayout() && changedScrapViewForPosition.hasAnyOfTheFlags(FragmentTransaction.TRANSIT_EXIT_MASK)) {
                changedScrapViewForPosition.setFlags(0, FragmentTransaction.TRANSIT_EXIT_MASK);
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                C0679r.m1916a(RecyclerView.this, RecyclerView.this.mUpdateChildViewsRunnable);
                return;
            }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C10421();
        Parcelable mLayoutState;

        static class C10421 implements ClassLoaderCreator<SavedState> {
            C10421() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        void postOnAnimation() {
            ...
            C0679r.m1916a(RecyclerView.this, (Runnable) this);
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    C0588b.m1561a(RecyclerView.TRACE_SCROLL_TAG);
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C10341();
        ...
        this.mItemAnimatorRunner = new C10352();
        this.mViewInfoProcessCallback = new C10374();
        ...
        this.mScaledHorizontalScrollFactor = C0680s.m1954a(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = C0680s.m1955b(viewConfiguration, context);
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0880c.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0880c.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0880c.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0880c.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0880c.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0880c.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0880c.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0880c.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private C0665j getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new C0665j(this);
        }
    ...
    private void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
        ...
        new StringBuilder("Problem while matching changed view holders with the newones. The pre-layout information for the change holder ").append(viewHolder2).append(" cannot be found but it is necessary for ").append(viewHolder).append(exceptionLabel());
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C10385());
    }
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            ensureLeftGlow();
            C0747g.m2144a(this.mLeftGlow, (-f2) / ((float) getWidth()), 1.0f - (f3 / ((float) getHeight())));
            obj2 = 1;
        } else if (f2 > 0.0f) {
            ensureRightGlow();
            C0747g.m2144a(this.mRightGlow, f2 / ((float) getWidth()), f3 / ((float) getHeight()));
            int i = 1;
        }
        if (f4 < 0.0f) {
            ensureTopGlow();
            C0747g.m2144a(this.mTopGlow, (-f4) / ((float) getHeight()), f / ((float) getWidth()));
        } else if (f4 > 0.0f) {
            ensureBottomGlow();
            C0747g.m2144a(this.mBottomGlow, f4 / ((float) getHeight()), 1.0f - (f / ((float) getWidth())));
        } else {
            obj = obj2;
        }
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            C0588b.m1561a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
            C0588b.m1560a();
        } else if (!this.mAdapterHelper.hasPendingUpdates()) {
        } else {
            if (this.mAdapterHelper.hasAnyUpdateTypes(4) && !this.mAdapterHelper.hasAnyUpdateTypes(11)) {
                C0588b.m1561a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                eatRequestLayout();
                onEnterLayoutOrScroll();
                this.mAdapterHelper.preProcess();
    ...
    void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), C0679r.m1937j(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), C0679r.m1938k(this)));
    }
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return getScrollingChildHelper().m1784a(f, f2, z);
    }

    public boolean dispatchNestedPreFling(float f, float f2) {
        return getScrollingChildHelper().m1783a(f, f2);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().m1789a(i, i2, iArr, iArr2);
    }

    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        return getScrollingChildHelper().m1790a(i, i2, iArr, iArr2, i3);
    }

    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return getScrollingChildHelper().m1787a(i, i2, i3, i4, iArr);
    }

    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        return getScrollingChildHelper().m1788a(i, i2, i3, i4, iArr, i5);
    }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore()) {
                ...
                if (i != -1) {
                    C0679r.m1906a(viewHolder.itemView, i);
    ...
    public ItemDecoration getItemDecorationAt(int i) {
        return (i < 0 || i >= this.mItemDecorations.size()) ? null : (ItemDecoration) this.mItemDecorations.get(i);
    }
    ...
    public boolean hasNestedScrollingParent() {
        return getScrollingChildHelper().m1785a(0);
    }

    public boolean hasNestedScrollingParent(int i) {
        return getScrollingChildHelper().m1785a(i);
    }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C10396());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0878a.fastscroll_default_thickness), resources.getDimensionPixelSize(C0878a.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0878a.fastscroll_margin));
    }
    ...
    public boolean isNestedScrollingEnabled() {
        return getScrollingChildHelper().f1965a;
    }
    ...
    L_0x0032:
        ...
        r0.<init>();
        r4.mGapWorker = r0;
        r0 = android.support.v4.view.C0679r.m1903D(r4);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        C0588b.m1561a(TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        C0588b.m1560a();
                ...
                case 2:
                    ...
                    if (actionMasked >= 0) {
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (scrollByInternal(canScrollHorizontally ? i : 0, canScrollVertically ? actionIndex : 0, obtain)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                            }
    ...
    void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            C0679r.m1916a((View) this, this.mItemAnimatorRunner);
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            eatRequestLayout();
            onEnterLayoutOrScroll();
            C0588b.m1561a(TRACE_SCROLL_TAG);
            fillRemainingScrollValues(this.mState);
            if (i != 0) {
        ...
        if (dispatchNestedScroll(i4, scrollHorizontallyBy, i3, i5, this.mScrollOffset, 0)) {
            ...
            if (motionEvent != null) {
                if ((motionEvent.getSource() & FragmentTransaction.TRANSIT_FRAGMENT_CLOSE) == FragmentTransaction.TRANSIT_FRAGMENT_CLOSE) {
                    scrollVerticallyBy = 1;
                } else {
                    boolean z = false;
                }
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        C0679r.m1913a((View) this, this.mAccessibilityDelegate);
    }
    ...
    public void setNestedScrollingEnabled(boolean z) {
        getScrollingChildHelper().m1782a(z);
    }
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        int a = accessibilityEvent != null ? C0613a.m1613a(accessibilityEvent) : 0;
        if (a != 0) {
            i = a;
        }
    ...
    public boolean startNestedScroll(int i) {
        return getScrollingChildHelper().m1786a(i, 0);
    }

    public boolean startNestedScroll(int i, int i2) {
        return getScrollingChildHelper().m1786a(i, i2);
    }

    public void stopNestedScroll() {
        getScrollingChildHelper().m1791b(0);
    }

    public void stopNestedScroll(int i) {
        getScrollingChildHelper().m1791b(i);
    }
