...
public class ActionMenuView extends LinearLayoutCompat implements C0949b, C0119p {
    ...
    private C0131h mMenu;
    C0155a mMenuBuilderCallback;
    ...
    private static class ActionMenuPresenterCallback implements C0803a {
    ...
    private class MenuBuilderCallback implements C0155a {
        MenuBuilderCallback() {
        }
        ...
        public void onMenuModeChange(C0131h c0131h) {
            if (ActionMenuView.this.mMenuBuilderCallback != null) {
                ActionMenuView.this.mMenuBuilderCallback.onMenuModeChange(c0131h);
            }
        }
    }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = actionMenuItemView != null && actionMenuItemView.m2762b();
        if (i2 <= 0 || (z2 && i2 < 2)) {
            i5 = 0;
        } else {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                boolean z2 = z && ((ActionMenuItemView) childAt).m2762b();
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu = new C0131h(context);
            this.mMenu.mo73a(new MenuBuilderCallback());
            this.mPresenter = new ActionMenuPresenter(context);
            this.mPresenter.setReserveOverflow(true);
            this.mPresenter.setCallback(this.mActionMenuPresenterCallback != null ? this.mActionMenuPresenterCallback : new ActionMenuPresenterCallback());
            this.mMenu.m253a(this.mPresenter, this.mPopupContext);
    ...
    public boolean invokeItem(C0967j c0967j) {
        return this.mMenu.m257a((MenuItem) c0967j, null, 0);
    }
