    ...
    public void runPendingAnimations() {
        ...
        if (i != 0 || i2 != 0 || i4 != 0 || i3 != 0) {
            ...
            if (i2 != 0) {
                ...
                if (i != 0) {
                    C0679r.m1917a(((MoveInfo) arrayList.get(0)).holder.itemView, c10031, getRemoveDuration());
                } else {
                    c10031.run();
                }
            }
            if (i3 != 0) {
                ...
                if (i != 0) {
                    C0679r.m1917a(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c10031, getRemoveDuration());
                } else {
                    c10031.run();
                }
            }
            if (i4 != 0) {
                ...
                if (i == 0 && i2 == 0 && i3 == 0) {
                    ...
                    C0679r.m1917a(((ViewHolder) arrayList2.get(0)).itemView, c10053, (i != 0 ? getRemoveDuration() : 0) + Math.max(i2 != 0 ? getMoveDuration() : 0, i3 != 0 ? getChangeDuration() : 0));
                }
            }
        }
    }
