...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C10571();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C10581();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C10581 implements Creator<FullSpanItem> {
                C10581() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C10591();
        ...
        static class C10591 implements Creator<SavedState> {
            C10591() {
            }
    ...
    private boolean preferLastSpan(int i) {
        if (this.mOrientation == 0) {
            return (i == -1) != this.mShouldReverseLayout ? true : DEBUG;
        } else {
            return ((i == -1) == this.mShouldReverseLayout) != isLayoutRTL() ? DEBUG : true;
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, C0626b c0626b) {
        ...
        if (layoutParams instanceof LayoutParams) {
            ...
            c0626b.m1688a(C0625l.m1681a(spanIndex, i2, i3, i, layoutParams2.mFullSpan, DEBUG));
            return;
        }
