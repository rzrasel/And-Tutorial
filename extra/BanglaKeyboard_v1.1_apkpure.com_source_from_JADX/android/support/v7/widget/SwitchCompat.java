...
import android.support.v7.p027g.C0882a;
...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0770a.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0779j.SwitchCompat, i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0779j.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0779j.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0779j.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0779j.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0779j.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0779j.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0779j.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0779j.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0779j.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0779j.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0779j.SwitchCompat_thumbTintMode, -1), null);
        ...
        colorStateList = obtainStyledAttributes.getColorStateList(C0779j.SwitchCompat_trackTint);
        if (colorStateList != null) {
            this.mTrackTintList = colorStateList;
            this.mHasTrackTint = true;
        }
        parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0779j.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C0779j.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C0366a.m1043a(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C0366a.m1046a(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C0366a.m1043a(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C0366a.m1046a(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                C0366a.m1042a(background, i2, i3, i, i5);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            C0366a.m1040a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            C0366a.m1040a(this.mTrackDrawable, f, f2);
        }
    }
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0779j.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0779j.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0779j.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0779j.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new C0882a(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(C0862b.m2514b(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(C0862b.m2514b(getContext(), i));
    }
