...
public class ListViewCompat extends ListView {
    ...
    private static class GateKeeperDrawable extends C0251a {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i8 < count) {
            ...
            view.forceLayout();
            listPaddingBottom = view.getMeasuredHeight() + (i8 > 0 ? listPaddingBottom + dividerHeight : listPaddingBottom);
            if (listPaddingBottom >= i4) {
                return (i5 < 0 || i8 <= i5 || i6 <= 0 || listPaddingBottom == i4) ? i4 : i6;
            } else {
                listPaddingTop = (i5 < 0 || i8 < i5) ? i6 : listPaddingBottom;
                i8++;
                i6 = listPaddingTop;
            }
        }
    ...
    protected void positionSelectorLikeFocusCompat(int i, View view) {
        ...
        if (z2) {
            ...
            C0366a.m1040a(selector, exactCenterX, exactCenterY);
        }
    }
