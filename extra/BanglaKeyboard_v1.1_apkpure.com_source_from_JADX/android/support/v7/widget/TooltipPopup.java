...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0776g.tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0775f.message);
        ...
        this.mLayoutParams.windowAnimations = C0778i.Animation_AppCompat_Tooltip;
        this.mLayoutParams.flags = 24;
    }

    private void computePosition(View view, int i, int i2, boolean z, LayoutParams layoutParams) {
        int i3;
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0773d.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0773d.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(z ? C0773d.tooltip_y_offset_touch : C0773d.tooltip_y_offset_non_touch);
