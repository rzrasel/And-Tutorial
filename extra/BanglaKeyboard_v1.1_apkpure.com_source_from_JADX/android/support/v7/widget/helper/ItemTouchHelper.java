...
import android.support.v4.view.C0655c;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    float mDx;
    float mDy;
    C0655c mGestureDetector;
    float mInitialTouchX;
    float mInitialTouchY;
    float mMaxSwipeVelocity;
    private final OnItemTouchListener mOnItemTouchListener = new C10712();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C10701();
    ...
    class C10701 implements Runnable {
        ...
        public void run() {
            if (ItemTouchHelper.this.mSelected != null && ItemTouchHelper.this.scrollIfNecessary()) {
                ...
                C0679r.m1916a(ItemTouchHelper.this.mRecyclerView, (Runnable) this);
            }
        }
    }

    class C10712 implements OnItemTouchListener {
        C10712() {
        }

        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ItemTouchHelper.this.mGestureDetector.m1742a(motionEvent);
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C10771 implements AnimatorUpdateListener {
            C10771() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C10771());
    ...
    class C10745 implements ChildDrawingOrderCallback {
        C10745() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C10751();
        private static final Interpolator sDragViewScrollCapInterpolator = new C10762();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class C10751 implements Interpolator {
            C10751() {
            }
        ...
        static class C10762 implements Interpolator {
            C10762() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0878a.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        final int getAbsoluteMovementFlags(RecyclerView recyclerView, ViewHolder viewHolder) {
            return convertToAbsoluteDirection(getMovementFlags(recyclerView, viewHolder), C0679r.m1932e(recyclerView));
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C10745();
            }
    ...
    private void initGestureDetector() {
        if (this.mGestureDetector == null) {
            this.mGestureDetector = new C0655c(this.mRecyclerView.getContext(), new ItemTouchHelperGestureListener());
        }
    }
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        int convertToAbsoluteDirection = (this.mCallback.convertToAbsoluteDirection(movementFlags, C0679r.m1932e(this.mRecyclerView)) & ACTION_MODE_SWIPE_MASK) >> 8;
        ...
        if (Math.abs(this.mDx) > Math.abs(this.mDy)) {
            ...
            if (movementFlags > 0) {
                return (i & movementFlags) == 0 ? Callback.convertToRelativeDirection(movementFlags, C0679r.m1932e(this.mRecyclerView)) : movementFlags;
            } else {
            ...
            movementFlags = checkHorizontalSwipe(viewHolder, convertToAbsoluteDirection);
            return movementFlags > 0 ? (i & movementFlags) == 0 ? Callback.convertToRelativeDirection(movementFlags, C0679r.m1932e(this.mRecyclerView)) : movementFlags : 0;
        }
    }
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0878a.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0878a.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c10723 = new RecoverAnimation(viewHolder2, i4, i2, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
                    ...
                    c10723.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c10723);
                    c10723.start();
                    obj = 1;
                } else {
