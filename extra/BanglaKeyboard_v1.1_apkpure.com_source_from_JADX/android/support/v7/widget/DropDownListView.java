...
import android.support.v4.widget.C0752i;
import android.support.v7.p021a.C0780a.C0770a;
import android.view.MotionEvent;
import android.view.View;

class DropDownListView extends ListViewCompat {
    private C0693v mClickAnimation;
    private boolean mDrawsInPressedState;
    private boolean mHijackFocus;
    private boolean mListSelectionHidden;
    private C0752i mScrollHelper;

    public DropDownListView(Context context, boolean z) {
        super(context, null, C0770a.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
    }
    ...
    public boolean onForwardedEvent(MotionEvent motionEvent, int i) {
        ...
        if (z2) {
            if (this.mScrollHelper == null) {
                this.mScrollHelper = new C0752i(this);
            }
            this.mScrollHelper.m2107a(true);
            this.mScrollHelper.onTouch(this, motionEvent);
        } else if (this.mScrollHelper != null) {
            this.mScrollHelper.m2107a(false);
        }
        return z2;
    }
