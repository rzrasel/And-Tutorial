...
import android.support.v4.widget.C0751h;
...
public class AppCompatImageHelper {
    ...
    private boolean applyFrameworkTintUsingColorFilter(Drawable drawable) {
        ...
        tintInfo.clear();
        ColorStateList a = C0751h.m2157a(this.mView);
        if (a != null) {
            tintInfo.mHasTintList = true;
            tintInfo.mTintList = a;
        }
        Mode b = C0751h.m2160b(this.mView);
        if (b != null) {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0779j.AppCompatImageView, i, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            if (drawable == null) {
                int resourceId = obtainStyledAttributes.getResourceId(C0779j.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
                    drawable = C0862b.m2514b(this.mView.getContext(), resourceId);
                    if (drawable != null) {
            ...
            if (obtainStyledAttributes.hasValue(C0779j.AppCompatImageView_tint)) {
                C0751h.m2158a(this.mView, obtainStyledAttributes.getColorStateList(C0779j.AppCompatImageView_tint));
            }
            if (obtainStyledAttributes.hasValue(C0779j.AppCompatImageView_tintMode)) {
                C0751h.m2159a(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0779j.AppCompatImageView_tintMode, -1), null));
            }
    ...
    public void setImageResource(int i) {
        if (i != 0) {
            Drawable b = C0862b.m2514b(this.mView.getContext(), i);
            if (b != null) {
