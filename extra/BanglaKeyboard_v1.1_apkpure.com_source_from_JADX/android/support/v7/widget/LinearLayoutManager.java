...
public class LinearLayoutManager extends LayoutManager implements ScrollVectorProvider, ViewDropHandler {
    ...
    static class LayoutState {
        ...
        void log() {
            new StringBuilder("avail:").append(this.mAvailable).append(", ind:").append(this.mCurrentPosition).append(", dir:").append(this.mItemDirection).append(", offset:").append(this.mOffset).append(", layoutDir:").append(this.mLayoutDirection);
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C10241();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        static class C10241 implements Creator<SavedState> {
            C10241() {
            }
    ...
    private void logChildren() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            new StringBuilder("item ").append(getPosition(childAt)).append(", coord:").append(this.mOrientationHelper.getDecoratedStart(childAt));
        }
    }
