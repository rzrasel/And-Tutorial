...
public class ActionBarOverlayLayout extends ViewGroup implements C0179k, DecorContentParent {
    static final int[] ATTRS = new int[]{C0770a.actionBarSize, 16842841};
    ...
    private final C0666m mParentHelper;
    ...
    class C09851 extends AnimatorListenerAdapter {
        C09851() {
        }
    ...
    class C09862 implements Runnable {
        C09862() {
        }
    ...
    class C09873 implements Runnable {
        C09873() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C09851();
        this.mRemoveActionBarHideOffset = new C09862();
        this.mAddActionBarHideOffset = new C09873();
        init(context);
        this.mParentHelper = new C0666m(this);
    }
    ...
    public int getNestedScrollAxes() {
        return this.mParentHelper.f1970a;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        Object obj = (C0679r.m1943p(this) & 256) != 0 ? 1 : null;
        if (obj != null) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0775f.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0775f.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0775f.action_bar));
        }
    }
    ...
    public void setMenu(Menu menu, C0803a c0803a) {
        pullChildren();
        this.mDecorToolbar.setMenu(menu, c0803a);
    }
