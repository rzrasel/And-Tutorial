...
import android.support.v7.p022b.C0859a.C0856b;
...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0855a.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0855a.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0856b.cardview_compat_inset_shadow);
