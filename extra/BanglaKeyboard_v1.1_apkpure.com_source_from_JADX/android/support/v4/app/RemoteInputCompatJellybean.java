...
class RemoteInputCompatJellybean {
    ...
    private static Intent getClipDataIntentFromIntent(Intent intent) {
        ...
        return (description.hasMimeType("text/vnd.android.intent") && description.getLabel().equals(RemoteInput.RESULTS_CLIP_LABEL)) ? clipData.getItemAt(0).getIntent() : null;
    }
    ...
    private static String getExtraResultsKeyForData(String str) {
        return new StringBuilder(EXTRA_DATA_TYPE_RESULTS_DATA).append(str).toString();
    }

    static Bundle getResultsFromIntent(Intent intent) {
        Intent clipDataIntentFromIntent = getClipDataIntentFromIntent(intent);
        return clipDataIntentFromIntent == null ? null : (Bundle) clipDataIntentFromIntent.getExtras().getParcelable(RemoteInput.EXTRA_RESULTS_DATA);
    }
