...
public class FragmentActivity extends BaseFragmentActivityApi16 implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C03971();
    int mNextCandidateRequestIndex;
    C0500n<String> mPendingFragmentActivityResults;
    ...
    static final class NonConfigurationInstances {
        ...
        C0477m<String, LoaderManager> loaders;
    ...
    private int allocateRequestIndex(Fragment fragment) {
        if (this.mPendingFragmentActivityResults.m1298a() >= MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS) {
            throw new IllegalStateException("Too many pending Fragment activity results.");
        }
        while (this.mPendingFragmentActivityResults.m1307f(this.mNextCandidateRequestIndex) >= 0) {
            this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS;
        }
        int i = this.mNextCandidateRequestIndex;
        this.mPendingFragmentActivityResults.m1300a(i, fragment.mWho);
        this.mNextCandidateRequestIndex = (this.mNextCandidateRequestIndex + 1) % MAX_NUM_PENDING_FRAGMENT_ACTIVITY_RESULTS;
        return i;
    }
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            int i4 = i3 - 1;
            String str = (String) this.mPendingFragmentActivityResults.m1299a(i4);
            this.mPendingFragmentActivityResults.m1302b(i4);
            if (str == null) {
        ...
        if (bundle != null) {
            ...
            if (bundle.containsKey(NEXT_CANDIDATE_REQUEST_INDEX_TAG)) {
                ...
                if (intArray == null || stringArray == null || intArray.length != stringArray.length) {
                    ...
                    this.mPendingFragmentActivityResults = new C0500n(intArray.length);
                    for (int i = 0; i < intArray.length; i++) {
                        this.mPendingFragmentActivityResults.m1300a(intArray[i], stringArray[i]);
                    }
                }
            }
        }
        if (this.mPendingFragmentActivityResults == null) {
            this.mPendingFragmentActivityResults = new C0500n();
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i2 != 0) {
            int i3 = i2 - 1;
            String str = (String) this.mPendingFragmentActivityResults.m1299a(i3);
            this.mPendingFragmentActivityResults.m1302b(i3);
            if (str == null) {
                Log.w(TAG, "Activity result delivered for unknown Fragment.");
                return;
            }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        C0477m retainLoaderNonConfig = this.mFragments.retainLoaderNonConfig();
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        if (this.mPendingFragmentActivityResults.m1298a() > 0) {
            bundle.putInt(NEXT_CANDIDATE_REQUEST_INDEX_TAG, this.mNextCandidateRequestIndex);
            int[] iArr = new int[this.mPendingFragmentActivityResults.m1298a()];
            String[] strArr = new String[this.mPendingFragmentActivityResults.m1298a()];
            for (int i = 0; i < this.mPendingFragmentActivityResults.m1298a(); i++) {
                iArr[i] = this.mPendingFragmentActivityResults.m1305d(i);
                strArr[i] = (String) this.mPendingFragmentActivityResults.m1306e(i);
            }
