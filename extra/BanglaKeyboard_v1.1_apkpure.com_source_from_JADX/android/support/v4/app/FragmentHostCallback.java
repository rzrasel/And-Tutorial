...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    private C0477m<String, LoaderManager> mAllLoaderManagers;
    ...
    LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new C0477m();
        }
    ...
    void reportLoaderStart() {
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                loaderManagerImplArr[i] = (LoaderManagerImpl) this.mAllLoaderManagers.m1250c(i);
            }
    ...
    void restoreLoaderNonConfig(C0477m<String, LoaderManager> c0477m) {
        if (c0477m != null) {
            int size = c0477m.size();
            for (int i = 0; i < size; i++) {
                ((LoaderManagerImpl) c0477m.m1250c(i)).updateHostController(this);
            }
        }
        this.mAllLoaderManagers = c0477m;
    }

    C0477m<String, LoaderManager> retainLoaderNonConfig() {
        int i;
        int i2 = 0;
        if (this.mAllLoaderManagers != null) {
            int size = this.mAllLoaderManagers.size();
            ...
            for (int i3 = size - 1; i3 >= 0; i3--) {
                loaderManagerImplArr[i3] = (LoaderManagerImpl) this.mAllLoaderManagers.m1250c(i3);
            }
