...
public class FragmentController {
    ...
    public void restoreLoaderNonConfig(C0477m<String, LoaderManager> c0477m) {
        this.mHost.restoreLoaderNonConfig(c0477m);
    }

    public C0477m<String, LoaderManager> retainLoaderNonConfig() {
