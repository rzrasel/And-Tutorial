...
import android.support.p003a.C0054a.C0046a;
import android.support.p003a.C0054a.C0047b;
import android.support.p003a.C0054a.C0048c;
import android.support.p003a.C0054a.C0049d;
import android.support.p003a.C0054a.C0050e;
import android.support.p003a.C0054a.C0051f;
import android.support.p003a.C0054a.C0052g;
import android.support.v4.app.NotificationCompatBase.Action.Factory;
import android.support.v4.app.NotificationCompatBase.UnreadConversation;
import android.support.v4.app.RemoteInputCompatBase.RemoteInput;
import android.support.v4.p017e.C0460a;
...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        public static final Factory FACTORY = new C04241();
        ...
        static class C04241 implements Factory {
            C04241() {
            }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0047b.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0047b.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0048c.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0049d.title, 8);
            remoteViews.setViewVisibility(C0049d.text2, 8);
            remoteViews.setViewVisibility(C0049d.text, 8);
        }
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (obj3 != null) {
                    remoteViews.setInt(C0049d.notification_background, "setBackgroundResource", C0048c.notification_bg_low);
                    remoteViews.setInt(C0049d.icon, "setBackgroundResource", C0048c.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0049d.notification_background, "setBackgroundResource", C0048c.notification_bg);
                    remoteViews.setInt(C0049d.icon, "setBackgroundResource", C0048c.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0049d.icon, 0);
                    remoteViews.setImageViewBitmap(C0049d.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0049d.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0047b.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0047b.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0049d.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0049d.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0049d.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0049d.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0049d.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0047b.notification_large_icon_width) - resources.getDimensionPixelSize(C0047b.notification_big_circle_margin), resources.getDimensionPixelSize(C0047b.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0049d.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0049d.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0049d.text, this.mBuilder.mContentText);
                obj3 = 1;
            } else {
                obj3 = null;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0049d.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0049d.info, 0);
                obj = 1;
                obj2 = 1;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0050e.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0049d.info, resources.getString(C0052g.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0049d.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0049d.info, 0);
                int i2 = 1;
                int i3 = 1;
            } else {
                remoteViews.setViewVisibility(C0049d.info, 8);
                obj = obj4;
                obj2 = obj3;
            }
            if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                remoteViews.setTextViewText(C0049d.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    remoteViews.setTextViewText(C0049d.text2, this.mBuilder.mContentText);
                    remoteViews.setViewVisibility(C0049d.text2, 0);
                    obj3 = 1;
                    if (obj3 != null && VERSION.SDK_INT >= 16) {
                        if (z2) {
                            remoteViews.setTextViewTextSize(C0049d.text, 0, (float) resources.getDimensionPixelSize(C0047b.notification_subtext_size));
                        }
                        remoteViews.setViewPadding(C0049d.line1, 0, 0, 0, 0);
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (this.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
                            remoteViews.setViewVisibility(C0049d.time, 0);
                            remoteViews.setLong(C0049d.time, "setTime", this.mBuilder.getWhenIfShowing());
                        } else {
                            remoteViews.setViewVisibility(C0049d.chronometer, 0);
                            remoteViews.setLong(C0049d.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(C0049d.chronometer, "setStarted", true);
                        }
                        obj = 1;
                    }
                    remoteViews.setViewVisibility(C0049d.right_side, obj == null ? 0 : 8);
                    remoteViews.setViewVisibility(C0049d.line3, obj2 == null ? 0 : 8);
                    return remoteViews;
                }
                remoteViews.setViewVisibility(C0049d.text2, 8);
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0049d.notification_main_column);
            remoteViews.addView(C0049d.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0049d.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0049d.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    protected static class BuilderExtender {
        ...
        public Notification build(Builder builder, NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (VERSION.SDK_INT >= 21 && builder.mStyle != null) {
                makeContentView = builder.mStyle.makeHeadsUpContentView(notificationBuilderWithBuilderAccessor);
                if (makeContentView != null) {
                    build.headsUpContentView = makeContentView;
                }
            }
            return build;
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final android.support.v4.app.NotificationCompatBase.UnreadConversation.Factory FACTORY = new C04251();
            ...
            static class C04251 implements android.support.v4.app.NotificationCompatBase.UnreadConversation.Factory {
                C04251() {
                }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2;
            int i;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0051f.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0049d.actions);
            if (z && this.mBuilder.mActions != null) {
                int min = Math.min(this.mBuilder.mActions.size(), 3);
                if (min > 0) {
                    for (int i2 = 0; i2 < min; i2++) {
                        applyStandardTemplate.addView(C0049d.actions, generateActionButton((Action) this.mBuilder.mActions.get(i2)));
                    }
                    z2 = true;
                    i = z2 ? 0 : 8;
                    applyStandardTemplate.setViewVisibility(C0049d.actions, i);
                    applyStandardTemplate.setViewVisibility(C0049d.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), obj != null ? C0051f.notification_action_tombstone : C0051f.notification_action);
            remoteViews.setImageViewBitmap(C0049d.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0046a.notification_action_color_filter)));
            remoteViews.setTextViewText(C0049d.action_text, action.title);
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0049d.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0049d.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            charSequence = a.m1199a(charSequence);
            ...
            spannableStringBuilder.append("  ").append(a.m1199a(message.getText() == null ? "" : message.getText()));
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (VERSION.SDK_INT >= 24) {
                ...
                for (Message findLatestIncomingMessage2 : this.mMessages) {
                    arrayList.add(findLatestIncomingMessage2.getText());
                    arrayList2.add(Long.valueOf(findLatestIncomingMessage2.getTimestamp()));
                    arrayList3.add(findLatestIncomingMessage2.getSender());
                    arrayList4.add(findLatestIncomingMessage2.getDataMimeType());
                    arrayList5.add(findLatestIncomingMessage2.getDataUri());
                }
            ...
            if (this.mConversationTitle != null) {
                ...
                notificationBuilderWithBuilderAccessor.getBuilder().setContentTitle(findLatestIncomingMessage2.getSender());
            }
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    CharSequence makeMessageLine = z ? makeMessageLine(findLatestIncomingMessage2) : findLatestIncomingMessage2.getText();
