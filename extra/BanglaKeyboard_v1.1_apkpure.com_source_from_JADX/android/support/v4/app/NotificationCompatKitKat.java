...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        private android.app.Notification.Builder f1402b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f1402b, action));
        }
        ...
        public Notification build() {
            ...
            this.f1402b.setExtras(this.mExtras);
            Notification build = this.f1402b.build();
