...
@Deprecated
public class ActionBarDrawerToggle implements C0389c {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = C0679r.m1932e(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = C0392a.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = C0392a.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.m2024d()) {
            this.mDrawerLayout.m2020b();
        } else {
            this.mDrawerLayout.m2014a();
        }
        return true;
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.m2022c() ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = C0392a.getDrawable(this.mActivity, i);
        }
