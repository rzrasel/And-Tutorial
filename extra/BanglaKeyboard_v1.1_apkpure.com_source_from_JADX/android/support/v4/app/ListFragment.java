...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C04212();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C04201();
    ...
    class C04212 implements OnItemClickListener {
        C04212() {
        }
