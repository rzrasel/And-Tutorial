...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C17492();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C17481();
    ...
    static class C17481 extends ThreadLocal<StringBuilder> {
        C17481() {
        }
    ...
    static class C17492 extends RequestHandler {
        C17492() {
        }
