...
public class ViewPager extends ViewGroup {
    private static final Comparator<ItemInfo> COMPARATOR = new C00181();
    ...
    private static final Interpolator sInterpolator = new C00192();
    ...
    static class C00181 implements Comparator<ItemInfo> {
        C00181() {
        }
    ...
    static class C00192 implements Interpolator {
        C00192() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00561());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C00561 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00561() {
            }
