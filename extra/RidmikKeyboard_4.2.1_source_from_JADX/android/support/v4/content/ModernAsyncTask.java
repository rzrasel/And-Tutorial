...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00131();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00542();

    static class C00131 implements ThreadFactory {
    ...
    class C00542 extends WorkerRunnable<Params, Result> {
        C00542() {
            super();
        }
