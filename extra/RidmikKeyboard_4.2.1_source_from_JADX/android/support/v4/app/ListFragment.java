...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00112();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00101();
    ...
    class C00112 implements OnItemClickListener {
        C00112() {
        }
