...
final class BackStackState implements Parcelable {
    public static final Creator<BackStackState> CREATOR = new C00001();
    ...
    /* compiled from: BackStackRecord */
    static class C00001 implements Creator<BackStackState> {
        C00001() {
        }
    ...
    public BackStackState(FragmentManagerImpl fm, BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            while (op != null) {
                ...
                pos = i + 1;
                this.mOps[i] = op.fragment.mIndex;
                i = pos + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            ...
            if (N > 0) {
                ...
                while (i < N) {
                    if (FragmentManagerImpl.DEBUG) {
                        Log.v("FragmentManager", "BSE " + bse + " set remove fragment #" + this.mOps[pos2]);
                    }
                    pos = pos2 + 1;
