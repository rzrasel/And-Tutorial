...
public class RecognitionView {
    ...
    private Runnable mUpdateVolumeRunnable = new C00451();
    private View mView;
    ...
    class C00473 implements Runnable {
        ...
        public void run() {
            RecognitionView.this.prepareDialog(false, RecognitionView.this.mContext.getText(C0053R.string.voice_initializing), RecognitionView.this.mInitializing, RecognitionView.this.mContext.getText(C0053R.string.cancel));
        }
    }
    ...
    class C00484 implements Runnable {
        ...
        public void run() {
            ...
            RecognitionView.this.prepareDialog(false, RecognitionView.this.mContext.getText(C0053R.string.voice_listening), (Drawable) RecognitionView.this.mSpeakNow.get(0), RecognitionView.this.mContext.getText(C0053R.string.cancel));
        }
    }
    ...
    public RecognitionView(Context context, OnClickListener clickListener) {
        this.mView = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0053R.layout.recognition_status, null);
        ...
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level0));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level1));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level2));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level3));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level4));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level5));
        this.mSpeakNow.add(r.getDrawable(C0053R.drawable.speak_now_level6));
        this.mInitializing = r.getDrawable(C0053R.drawable.mic_slash);
        this.mError = r.getDrawable(C0053R.drawable.caution);
        this.mImage = (ImageView) this.mView.findViewById(C0053R.id.image);
        this.mButton = this.mView.findViewById(C0053R.id.button);
        this.mButton.setOnClickListener(clickListener);
        this.mText = (TextView) this.mView.findViewById(C0053R.id.text);
        this.mButtonText = (TextView) this.mView.findViewById(C0053R.id.button_text);
        this.mProgress = this.mView.findViewById(C0053R.id.progress);
    ...
    public void restoreState() {
        this.mUiHandler.post(new C00462());
    }

    public void showInitializing() {
        this.mUiHandler.post(new C00473());
    }

    public void showListening() {
        this.mUiHandler.post(new C00484());
    ...
    public void showError(final String message) {
        this.mUiHandler.post(new Runnable() {
            public void run() {
                RecognitionView.this.mState = State.READY;
                RecognitionView.this.prepareDialog(false, message, RecognitionView.this.mError, RecognitionView.this.mContext.getText(C0053R.string.ok));
            }
        });
    }
    ...
    public void showWorking(final ByteArrayOutputStream waveBuffer, final int speechStartPosition, final int speechEndPosition) {
        this.mUiHandler.post(new Runnable() {
            public void run() {
                ...
                RecognitionView.this.prepareDialog(true, RecognitionView.this.mContext.getText(C0053R.string.voice_working), null, RecognitionView.this.mContext.getText(C0053R.string.cancel));
    ...
    public void finish() {
        this.mUiHandler.post(new C00517());
    }
