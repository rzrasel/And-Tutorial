...
public class SeekBarPreference extends DialogPreference {
    ...
    class C00271 implements OnSeekBarChangeListener {
        C00271() {
        }
    ...
    protected void init(Context context, AttributeSet attrs) {
        setDialogLayoutResource(C0053R.layout.seek_bar_dialog);
        TypedArray a = context.obtainStyledAttributes(attrs, C0053R.styleable.SeekBarPreference);
    ...
    protected void onBindDialogView(View view) {
        this.mSeek = (SeekBar) view.findViewById(C0053R.id.seekBarPref);
        this.mMinText = (TextView) view.findViewById(C0053R.id.seekMin);
        this.mMaxText = (TextView) view.findViewById(C0053R.id.seekMax);
        this.mValText = (TextView) view.findViewById(C0053R.id.seekVal);
        showVal();
        ...
        this.mSeek.setOnSeekBarChangeListener(new C00271());
