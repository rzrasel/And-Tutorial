...
public class CandidateView extends View {
    ...
    public CandidateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mSelectionHighlight = context.getResources().getDrawable(C0053R.drawable.list_selector_background_pressed);
        LayoutInflater inflate = (LayoutInflater) context.getSystemService("layout_inflater");
        Resources res = context.getResources();
        this.mPreviewPopup = new PopupWindow(context);
        this.mPreviewText = (TextView) inflate.inflate(C0053R.layout.candidate_preview, null);
        ...
        this.mColorNormal = res.getColor(C0053R.color.candidate_normal);
        this.mColorRecommended = res.getColor(C0053R.color.candidate_recommended);
        this.mColorOther = res.getColor(C0053R.color.candidate_other);
        this.mDivider = res.getDrawable(C0053R.drawable.keyboard_suggest_strip_divider);
        this.mAddToDictionaryHint = res.getString(C0053R.string.hint_add_to_dictionary);
        ...
        this.mMinTouchableWidth = (int) res.getDimension(C0053R.dimen.candidate_min_touchable_width);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mTotalWidth = 0;
        if (this.mService == null || !(this.mService.mKeyboardSwitcher.getLayoutId() == LatinIME.LOLIPOP_THEME_INDEX || this.mService.mKeyboardSwitcher.getLayoutId() == LatinIME.LOLIPOP_THEME_INDEX + 1)) {
            this.mColorNormal = getContext().getResources().getColor(C0053R.color.candidate_normal);
            this.mColorRecommended = getContext().getResources().getColor(C0053R.color.candidate_recommended);
            this.mColorOther = getContext().getResources().getColor(C0053R.color.candidate_recommended);
        } else {
            this.mColorNormal = getContext().getResources().getColor(C0053R.color.candidate_normal_lolipop);
            this.mColorRecommended = getContext().getResources().getColor(C0053R.color.candidate_recommended_lolipop);
            this.mColorOther = getContext().getResources().getColor(C0053R.color.candidate_recommended_lolipop);
        }
        ...
        if (this.mBgPadding == null) {
            ...
            this.mDivider.setBounds(0, 0, getWidth(), getHeight());
        }
