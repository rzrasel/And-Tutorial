...
public class KeyboardSwitcher implements OnSharedPreferenceChangeListener {
    private static final int[] ALPHABET_MODES = new int[]{C0053R.id.mode_normal, C0053R.id.mode_url, C0053R.id.mode_email, C0053R.id.mode_im, C0053R.id.mode_webentry, C0053R.id.mode_normal_with_settings_key, C0053R.id.mode_url_with_settings_key, C0053R.id.mode_email_with_settings_key, C0053R.id.mode_im_with_settings_key, C0053R.id.mode_webentry_with_settings_key};
    ...
    private static final int[] KBD_PHONE = new int[]{C0053R.xml.kbd_phone, C0053R.xml.kbd_phone_black};
    private static final int[] KBD_PHONE_SYMBOLS = new int[]{C0053R.xml.kbd_phone_symbols, C0053R.xml.kbd_phone_symbols_black};
    private static final int[] KBD_QWERTY = new int[]{C0053R.xml.kbd_qwerty, C0053R.xml.kbd_qwerty_black};
    private static final int[] KBD_QWERTY_BANGLA = new int[]{C0053R.xml.kbd_qwerty_bangla, C0053R.xml.kbd_qwerty_bangla_black};
    private static final int[] KBD_QWERTY_BANGLA_ASCII = new int[]{C0053R.xml.kbd_qwerty_bangla_ascii, C0053R.xml.kbd_qwerty_bangla_black};
    private static final int[] KBD_SMILEY = new int[]{C0053R.xml.kbd_smileys1, C0053R.xml.kbd_smileys2, C0053R.xml.kbd_smileys3};
    private static final int[] KBD_SYMBOLS = new int[]{C0053R.xml.kbd_symbols, C0053R.xml.kbd_symbols_black};
    private static final int KBD_SYMBOLS_ASCII = 2131034132;
    private static final int KBD_SYMBOLS_BANGLA_ASCII = 2131034133;
    private static final int[] KBD_SYMBOLS_SHIFT = new int[]{C0053R.xml.kbd_symbols_shift, C0053R.xml.kbd_symbols_shift_black};
    ...
    private static final int[] THEMES = new int[]{C0053R.layout.input_ics, C0053R.layout.input_iphone, C0053R.layout.input_ridmik_blue, C0053R.layout.input_lolipop, C0053R.layout.input_lolipop_light};
    ...
    private KeyboardId makeSymbolsId(boolean hasVoice) {
        int i = C0053R.id.mode_symbols_with_settings_key;
        if (!useAsciiLayout()) {
            int i2 = KBD_SYMBOLS[getCharColorId()];
            if (!this.mHasSettingsKey) {
                i = C0053R.id.mode_symbols;
            }
            ...
            return new KeyboardId(C0053R.xml.kbd_symbols_ascii, i, false, hasVoice);
        } else {
            if (!this.mHasSettingsKey) {
                i = C0053R.id.mode_symbols;
            }
            return new KeyboardId(C0053R.xml.kbd_symbols_bangla_ascii, i, false, hasVoice);
        }
    }
    ...
    private KeyboardId makeSymbolsShiftedId(boolean hasVoice) {
        ...
        if (useAsciiLayout()) {
            ...
            return new KeyboardId(C0053R.xml.kbd_symbols_shift_ascii, i, false, hasVoice);
        }
    ...
    private LatinKeyboard getKeyboard(KeyboardId id) {
        ...
        if (keyboard == null) {
            ...
            boolean z = id.mXml == C0053R.xml.kbd_symbols || id.mXml == C0053R.xml.kbd_symbols_black || id.mXml == C0053R.xml.kbd_symbols_ascii || id.mXml == C0053R.xml.kbd_symbols_bangla_ascii;
    ...
    private KeyboardId getKeyboardId(int mode, int imeOptions, boolean isSymbols) {
        ...
        if (!isSymbols) {
            ...
            switch (mode) {
                ...
                case 4:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? C0053R.id.mode_url_with_settings_key : C0053R.id.mode_url, true, hasVoice);
                case 5:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? C0053R.id.mode_email_with_settings_key : C0053R.id.mode_email, true, hasVoice);
                case 6:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? C0053R.id.mode_im_with_settings_key : C0053R.id.mode_im, true, hasVoice);
                case 7:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? C0053R.id.mode_webentry_with_settings_key : C0053R.id.mode_webentry, true, hasVoice);
                case 8:
                    return new KeyboardId(KBD_SMILEY[0], C0053R.id.mode_normal, false, hasVoice);
                case 9:
                    return new KeyboardId(KBD_SMILEY[1], C0053R.id.mode_normal, false, hasVoice);
                case 10:
                    return new KeyboardId(KBD_SMILEY[2], C0053R.id.mode_normal, false, hasVoice);
                case 11:
                    int xmlResId = 0;
                    if (CURRENT_FIXED_LAYOUT == 1) {
                        if (useAsciiLayout()) {
                            xmlResId = C0053R.xml.kbd_unijoy_ascii;
                        } else {
                            xmlResId = C0053R.xml.kbd_unijoy;
                        }
                    } else if (CURRENT_FIXED_LAYOUT == 2) {
                        if (useAsciiLayout()) {
                            xmlResId = C0053R.xml.kbd_national_ascii;
                        } else {
                            xmlResId = C0053R.xml.kbd_national;
                        }
                    }
                    return new KeyboardId(xmlResId, C0053R.id.mode_normal, false, hasVoice);
                case 12:
                    int xmlResId1 = 0;
                    if (CURRENT_FIXED_LAYOUT == 1) {
                        if (useAsciiLayout()) {
                            xmlResId1 = C0053R.xml.kbd_unijoy_shift_ascii;
                        } else {
                            xmlResId1 = C0053R.xml.kbd_unijoy_shift;
                        }
                    } else if (CURRENT_FIXED_LAYOUT == 2) {
                        if (useAsciiLayout()) {
                            xmlResId1 = C0053R.xml.kbd_national_shift_ascii;
                        } else {
                            xmlResId1 = C0053R.xml.kbd_national_shift;
                        }
                    }
                    return new KeyboardId(xmlResId1, C0053R.id.mode_normal, false, hasVoice);
                default:
                    return null;
            }
            return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? C0053R.id.mode_normal_with_settings_key : C0053R.id.mode_normal, true, hasVoice);
        } else if (mode == 3) {
    ...
    private void changeLatinKeyboardView(int newLayout, boolean forceReset) {
        ...
        this.mInputMethodService.mHandler.post(new C00291());
    }
    ...
    private void updateSettingsKeyState(SharedPreferences prefs) {
        ...
        String settingsKeyMode = prefs.getString("settings_key", resources.getString(C0053R.string.settings_key_mode_auto));
        if (settingsKeyMode.equals(resources.getString(C0053R.string.settings_key_mode_always_show)) || (settingsKeyMode.equals(resources.getString(C0053R.string.settings_key_mode_auto)) && LatinIMEUtil.hasMultipleEnabledIMEs(this.mInputMethodService))) {
