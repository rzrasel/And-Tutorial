            ...
            if (this.outer.mPlaying) {
                ...
                switch (msg.what) {
                    case 1:
                        ...
                        while (true) {
                            if (c > 'ÿ' || this.outer.mAsciiKeys[c] == null) {
                                ...
                                MotionEvent me = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 0, (float) (this.outer.mAsciiKeys[c].f0x + 10), (float) (this.outer.mAsciiKeys[c].f1y + 26), 0);
                    ...
                    case 2:
                        ...
                        int x2 = this.outer.mAsciiKeys[cUp].f0x + 10;
                        int y2 = this.outer.mAsciiKeys[cUp].f1y + 26;
                        latinKeyboardView = this.outer;
                        latinKeyboardView.mStringIndex = latinKeyboardView.mStringIndex + 1;
