...
public class DialogSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    public DialogSeekBarPreference(Context context, AttributeSet attrs) {
        ...
        setDialogLayoutResource(C0053R.layout.my_seekbar_preference);
    }

    protected void onBindDialogView(View v) {
        super.onBindDialogView(v);
        ((TextView) v.findViewById(C0053R.id.dialogMessage)).setText(getDialogMessage());
        this.mValueText = (TextView) v.findViewById(C0053R.id.actualValue);
        this.mSeekBar = (SeekBar) v.findViewById(C0053R.id.myBar);
