...
public class LatinKeyboard extends Keyboard {
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        public SlidingLocaleDrawable(Drawable background, int width, int height) {
            ...
            this.mTextPaint.setColor(C0053R.color.latinkeyboard_transparent);
            this.mTextPaint.setTextAlign(Align.CENTER);
            this.mTextPaint.setAlpha(255);
            this.mTextPaint.setAntiAlias(true);
            this.mMiddleX = (this.mWidth - this.mBackground.getIntrinsicWidth()) / 2;
            this.mLeftDrawable = LatinKeyboard.this.mRes.getDrawable(C0053R.drawable.sym_keyboard_feedback_language_arrows_left);
            this.mRightDrawable = LatinKeyboard.this.mRes.getDrawable(C0053R.drawable.sym_keyboard_feedback_language_arrows_right);
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.mHitThreshold) {
                ...
                paint.setColor(LatinKeyboard.this.mRes.getColor(C0053R.color.latinkeyboard_feedback_language_text));
                if (LatinKeyboard.this.mThemeIndex == LatinIME.LOLIPOP_THEME_INDEX || LatinKeyboard.this.mThemeIndex == LatinIME.LOLIPOP_THEME_INDEX + 1) {
                    paint.setColor(LatinKeyboard.this.mRes.getColor(C0053R.color.latinkeyboard_key_color_black));
                }
                if (LatinIME.useBanglaFont()) {
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode, int keyboardHeightPercentage) {
        ...
        this.mMode = mode;
        this.mRes = res;
        this.mShiftLockIcon = res.getDrawable(C0053R.drawable.sym_keyboard_shift_locked);
        this.mShiftLockPreviewIcon = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_shift_locked);
        setDefaultBounds(this.mShiftLockPreviewIcon);
        this.mOldShiftIcon = res.getDrawable(C0053R.drawable.sym_keyboard_shift);
        this.mSpaceIcon = res.getDrawable(C0053R.drawable.sym_keyboard_space);
        this.mSpaceAutoCompletionIndicator = res.getDrawable(C0053R.drawable.sym_keyboard_space_led);
        this.mSpacePreviewIcon = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_space);
        this.mMicIcon = res.getDrawable(C0053R.drawable.sym_keyboard_mic);
        this.mMicPreviewIcon = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_mic);
        setDefaultBounds(this.mMicPreviewIcon);
        this.mButtonArrowLeftIcon = res.getDrawable(C0053R.drawable.sym_keyboard_language_arrows_left);
        this.mButtonArrowRightIcon = res.getDrawable(C0053R.drawable.sym_keyboard_language_arrows_right);
        this.m123MicIcon = res.getDrawable(C0053R.drawable.sym_keyboard_123_mic);
        this.m123MicPreviewIcon = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_123_mic);
        this.mHintIcon = res.getDrawable(C0053R.drawable.hint_popup);
        setDefaultBounds(this.m123MicPreviewIcon);
        sSpacebarVerticalCorrection = res.getDimensionPixelOffset(C0053R.dimen.spacebar_vertical_correction);
        boolean z;
        if (LatinIME.langNow != 1) {
            z = (xmlLayoutResId == C0053R.xml.kbd_qwerty || xmlLayoutResId == C0053R.xml.kbd_qwerty_black) ? true : DEBUG_PREFERRED_LETTER;
            this.mIsAlphaKeyboard = z;
        } else if (LatinIME.useBanglaFont()) {
            z = (xmlLayoutResId == C0053R.xml.kbd_qwerty_bangla_ascii || xmlLayoutResId == C0053R.xml.kbd_qwerty_bangla_black) ? true : DEBUG_PREFERRED_LETTER;
            this.mIsAlphaKeyboard = z;
        } else {
            z = (xmlLayoutResId == C0053R.xml.kbd_qwerty_bangla || xmlLayoutResId == C0053R.xml.kbd_qwerty_bangla_black) ? true : DEBUG_PREFERRED_LETTER;
            this.mIsAlphaKeyboard = z;
        }
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
        ...
        switch (key.codes[0]) {
            case -103:
                ...
                break;
            case -102:
                key.icon = res.getDrawable(C0053R.drawable.sym_keyboard_mic);
                break;
            case -100:
                key.icon = res.getDrawable(C0053R.drawable.sym_keyboard_settings);
                break;
            case Keyboard.KEYCODE_DELETE /*-5*/:
                key.icon = res.getDrawable(C0053R.drawable.sym_keyboard_delete);
                break;
            case -2:
                this.m123Key = key;
                ...
                break;
            case -1:
                key.icon = res.getDrawable(C0053R.drawable.sym_keyboard_shift);
                break;
            case 9:
                key.icon = res.getDrawable(C0053R.drawable.sym_keyboard_tab);
                break;
            case 10:
                this.mEnterKey = key;
                break;
        ...
        if (this.mEnterKey != null) {
            ...
            switch (1073742079 & options) {
                case 2:
                    ...
                    this.mEnterKey.label = res.getText(C0053R.string.label_go_key);
                    break;
                case 3:
                    this.mEnterKey.iconPreview = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_search);
                    this.mEnterKey.icon = res.getDrawable(this.mIsBlackSym ? C0053R.drawable.sym_bkeyboard_search : C0053R.drawable.sym_keyboard_search);
                    this.mEnterKey.label = null;
                    break;
                case 4:
                    this.mEnterKey.iconPreview = null;
                    this.mEnterKey.icon = null;
                    this.mEnterKey.label = res.getText(C0053R.string.label_send_key);
                    break;
                case 5:
                    this.mEnterKey.iconPreview = null;
                    this.mEnterKey.icon = null;
                    this.mEnterKey.label = res.getText(C0053R.string.label_next_key);
                    break;
                case 6:
                    this.mEnterKey.iconPreview = null;
                    this.mEnterKey.icon = null;
                    this.mEnterKey.label = res.getText(C0053R.string.label_done_key);
                    break;
                default:
                    if (mode == 6) {
                        this.mEnterKey.text = "\n";
                    }
                    this.mEnterKey.iconPreview = res.getDrawable(C0053R.drawable.sym_keyboard_feedback_return);
                    this.mEnterKey.icon = res.getDrawable(this.mIsBlackSym ? C0053R.drawable.sym_bkeyboard_return : C0053R.drawable.sym_keyboard_return);
                    this.mEnterKey.label = null;
                    break;
            }
    ...
    public void setColorOfSymbolIcons(boolean isAutoCompletion, boolean isBlack) {
        ...
        if (isBlack) {
            this.mShiftLockIcon = this.mRes.getDrawable(C0053R.drawable.sym_bkeyboard_shift_locked);
            this.mSpaceIcon = this.mRes.getDrawable(C0053R.drawable.sym_bkeyboard_space);
            this.mMicIcon = this.mRes.getDrawable(C0053R.drawable.sym_bkeyboard_mic);
            this.m123MicIcon = this.mRes.getDrawable(C0053R.drawable.sym_bkeyboard_123_mic);
        } else {
            this.mShiftLockIcon = this.mRes.getDrawable(C0053R.drawable.sym_keyboard_shift_locked);
            this.mSpaceIcon = this.mRes.getDrawable(C0053R.drawable.sym_keyboard_space);
            this.mMicIcon = this.mRes.getDrawable(C0053R.drawable.sym_keyboard_mic);
            this.m123MicIcon = this.mRes.getDrawable(C0053R.drawable.sym_keyboard_123_mic);
        }
        updateDynamicKeys();
    ...
    private void updateF1Key() {
        if (this.mF1Key != null) {
            if (this.mIsAlphaKeyboard) {
                if (this.mMode == 4) {
                    setNonMicF1Key(this.mF1Key, "/", C0053R.xml.popup_slash);
                } else if (this.mMode == 5) {
                    setNonMicF1Key(this.mF1Key, "@", C0053R.xml.popup_at);
                } else if (this.mVoiceEnabled && this.mHasVoiceButton) {
                    setMicF1Key(this.mF1Key);
                } else {
                    setNonMicF1Key(this.mF1Key, ",", C0053R.xml.popup_comma);
                }
            } else if (this.mVoiceEnabled && this.mHasVoiceButton) {
                setMicF1Key(this.mF1Key);
            } else {
    ...
    private void setMicF1Key(Key key) {
        ...
        key.popupResId = C0053R.xml.popup_mic;
    ...
    public static boolean hasPuncOrSmileysPopup(Key key) {
        return (key.popupResId == C0053R.xml.popup_punctuation || key.popupResId == C0053R.xml.popup_smileys) ? true : DEBUG_PREFERRED_LETTER;
    }
    ...
    private Bitmap drawSynthesizedSettingsHintImage(int width, int height, Drawable mainIcon, Drawable hintIcon) {
        ...
        canvas.drawColor(this.mRes.getColor(C0053R.color.latinkeyboard_transparent), Mode.CLEAR);
    ...
    private Bitmap drawSpaceBar(int opacity, boolean isAutoCompletion, boolean isBlack) {
        ...
        if (isBlack) {
            i = C0053R.color.latinkeyboard_key_color_black;
        } else {
            i = C0053R.color.latinkeyboard_key_color_white;
        }
    ...
    private int distanceFrom(Key k, int x, int y) {
        if (y <= k.f1y || y >= k.f1y + k.height) {
            return Integer.MAX_VALUE;
        }
        return Math.abs((k.f0x + (k.width / 2)) - x);
    }
