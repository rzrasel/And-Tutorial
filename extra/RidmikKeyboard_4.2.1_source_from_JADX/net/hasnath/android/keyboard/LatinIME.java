...
public class LatinIME extends InputMethodService implements OnKeyboardActionListener, UiListener, OnSharedPreferenceChangeListener {
    ...
    private BroadcastReceiver mReceiver = new C00301();
    ...
    class C00592 implements Display {
        C00592() {
        }
    ...
    public void onCreate() {
        ...
        this.mReCorrectionEnabled = prefs.getBoolean(PREF_RECORRECTION_ENABLED, getResources().getBoolean(C0053R.bool.default_recorrection_enabled));
        ...
        this.mHints = new Hints(this, new C00592());
    ...
    static int[] getDictionary(Resources res) {
        ...
        if (langNow == 1 || langNow == 3) {
            dict[0] = C0053R.raw.words;
        } else {
            dict[0] = C0053R.raw.main;
        }
        return dict;
    }
    ...
    private void initSuggest(String locale) {
        ...
        this.mWordSeparators = this.mResources.getString(C0053R.string.word_separators);
        this.mSentenceSeparators = this.mResources.getString(C0053R.string.sentence_separators);
    ...
    public View onCreateCandidatesView() {
        ...
        if (this.mKeyboardSwitcher.getLayoutId() == LOLIPOP_THEME_INDEX || this.mKeyboardSwitcher.getLayoutId() == LOLIPOP_THEME_INDEX + 1) {
            this.mCandidateViewContainer = (LinearLayout) getLayoutInflater().inflate(C0053R.layout.candidates_lolipop, null);
        } else {
            this.mCandidateViewContainer = (LinearLayout) getLayoutInflater().inflate(C0053R.layout.candidates, null);
        }
        this.mCandidateView = (CandidateView) this.mCandidateViewContainer.findViewById(C0053R.id.candidates);
    ...
    public boolean onEvaluateFullscreenMode() {
        if (((float) getResources().getDisplayMetrics().heightPixels) > getResources().getDimension(C0053R.dimen.max_height_for_fullscreen)) {
            return false;
        }
    ...
    private void showVoiceWarningDialog(final boolean swipe) {
        ...
        builder.setIcon(C0053R.drawable.ic_mic_dialog);
        ...
        builder.setNegativeButton(17039360, new C00346());
        if (this.mLocaleSupportedForVoiceInput) {
            builder.setMessage(getString(C0053R.string.voice_warning_may_not_understand) + "\n\n" + getString(C0053R.string.voice_warning_how_to_turn_off));
        } else {
            builder.setMessage(getString(C0053R.string.voice_warning_locale_not_supported) + "\n\n" + getString(C0053R.string.voice_warning_may_not_understand) + "\n\n" + getString(C0053R.string.voice_warning_how_to_turn_off));
        }
        builder.setTitle(C0053R.string.voice_warning_title);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (PREF_SELECTED_LANGUAGES.equals(key)) {
            ...
            this.mReCorrectionEnabled = sharedPreferences.getBoolean(PREF_RECORRECTION_ENABLED, getResources().getBoolean(C0053R.bool.default_recorrection_enabled));
    ...
    private void loadSettings() {
        ...
        this.mPopupOn = sp.getBoolean(PREF_POPUP_ON, this.mResources.getBoolean(C0053R.bool.default_popup_preview));
        this.mAutoCap = sp.getBoolean(PREF_AUTO_CAP, false);
        this.mEnableVolumeCursor = sp.getBoolean(PREF_VOLUME_KEYS_AS_CURSOR, false);
        this.mLongPressDelay = sp.getInt("long_press_delay", getResources().getInteger(C0053R.integer.config_long_press_key_timeout));
        ...
        if (sp.getString(PREF_VOICE_MODE, getString(C0053R.string.voice_mode_main)).equals(getString(C0053R.string.voice_mode_off)) || !this.mEnableVoiceButton) {
            enableVoice = false;
        }
        ...
        this.mAutoCorrectEnabled = sp.getBoolean(PREF_AUTO_COMPLETE, this.mResources.getBoolean(C0053R.bool.enable_autocorrect)) & this.mShowSuggestions;
        updateCorrectionMode();
    ...
    private void initSuggestPuncList() {
        ...
        this.mSuggestPuncs = this.mResources.getString(C0053R.string.suggested_punctuations);
    ...
    private void showOptionsMenu() {
        Builder builder = new Builder(this);
        builder.setCancelable(true);
        builder.setIcon(C0053R.drawable.ic_dialog_keyboard);
        builder.setNegativeButton(17039360, null);
        CharSequence itemSettings = getString(C0053R.string.english_ime_settings);
        builder.setItems(new CharSequence[]{getString(C0053R.string.selectInputMethod), "Ridmik Key Map", itemSettings}, new C00357());
        builder.setTitle(this.mResources.getString(C0053R.string.english_ime_input_options));
