...
public abstract class C0105d extends BaseAdapter implements C0104h, Filterable {
    @Deprecated
    public static final int FLAG_AUTO_REQUERY = 1;
    public static final int FLAG_REGISTER_CONTENT_OBSERVER = 2;
    protected boolean mAutoRequery;
    protected C0106e mChangeObserver;
    protected Context mContext;
    protected Cursor mCursor;
    protected C0108g mCursorFilter;
    ...
    @Deprecated
    public C0105d(Context context, Cursor cursor) {
        init(context, cursor, 1);
    }

    public C0105d(Context context, Cursor cursor, int i) {
        init(context, cursor, i);
    }

    public C0105d(Context context, Cursor cursor, boolean z) {
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new C0108g(this);
        }
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        if ((i & 2) == 2) {
            this.mChangeObserver = new C0106e(this);
            this.mDataSetObserver = new C0107f();
        } else {
