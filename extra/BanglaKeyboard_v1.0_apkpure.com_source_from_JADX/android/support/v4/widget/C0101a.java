...
final class C0101a implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f282b.length - 1)) * f), f282b.length - 2);
        float f2 = (f - (((float) min) * f283c)) / f283c;
        return ((f282b[min + 1] - f282b[min]) * f2) + f282b[min];
    }
}
