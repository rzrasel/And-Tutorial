...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    private static final C0028l sClassMap = new C0028l();
    ...
    class C00081 implements FragmentContainer {
        C00081() {
        }
    ...
    public class SavedState implements Parcelable {
        public static final Creator CREATOR = new C00091();
        final Bundle mState;

        final class C00091 implements Creator {
            C00091() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C00081(), this);
    }
