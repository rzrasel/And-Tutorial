...
final class BackStackState implements Parcelable {
    public static final Creator CREATOR = new C00071();
    ...
    final class C00071 implements Creator {
        C00071() {
        }
    ...
    public final BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i2 < this.mOps.length) {
            ...
            if (FragmentManagerImpl.DEBUG) {
                "Instantiate " + backStackRecord + " op #" + i + " base fragment #" + this.mOps[i3];
            }
            int i4 = i3 + 1;
            i2 = this.mOps[i3];
            if (i2 >= 0) {
            ...
            if (i6 > 0) {
                ...
                while (i3 < i6) {
                    if (FragmentManagerImpl.DEBUG) {
                        "Instantiate " + backStackRecord + " set remove fragment #" + this.mOps[i4];
                    }
                    i5 = i4 + 1;
