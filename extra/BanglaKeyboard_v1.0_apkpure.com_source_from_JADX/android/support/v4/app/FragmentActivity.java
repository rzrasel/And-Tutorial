...
import android.support.v4.p001b.C0028l;
...
public class FragmentActivity extends Activity {
    ...
    C0028l mAllLoaderManagers;
    boolean mCheckedForLoaderManager;
    final FragmentContainer mContainer = new C00112();
    boolean mCreated;
    final FragmentManagerImpl mFragments = new FragmentManagerImpl();
    final Handler mHandler = new C00101();
    ...
    class C00112 implements FragmentContainer {
        C00112() {
        }
    ...
    LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new C0028l();
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i3 = size - 1; i3 >= 0; i3--) {
                loaderManagerImplArr[i3] = (LoaderManagerImpl) this.mAllLoaderManagers.m8b(i3);
            }
            i2 = 0;
            while (i < size) {
    ...
    protected void onStart() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                loaderManagerImplArr[i] = (LoaderManagerImpl) this.mAllLoaderManagers.m8b(i);
            }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i) {
        if (i == -1) {
            ...
            super.startActivityForResult(intent, ((fragment.mIndex + 1) << 16) + (Menu.USER_MASK & i));
        }
    }
