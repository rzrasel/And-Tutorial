...
import android.support.v4.widget.C0005k;
import android.support.v4.widget.DrawerLayout;
import android.view.MenuItem;
import android.view.View;

public class ActionBarDrawerToggle implements C0005k {
    ...
    class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = an.m339f(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.m539d()) {
            this.mDrawerLayout.m536b();
        } else {
            this.mDrawerLayout.m531a();
        }
        return true;
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.m538c() ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
