...
public final class mz {
    ...
    public static int m2654a(int[] iArr) {
        return (iArr == null || iArr.length == 0) ? 0 : Arrays.hashCode(iArr);
    }

    public static int m2655a(Object[] objArr) {
        int i = 0;
    ...
    public static boolean m2656a(int[] iArr, int[] iArr2) {
        return (iArr == null || iArr.length == 0) ? iArr2 == null || iArr2.length == 0 : Arrays.equals(iArr, iArr2);
    }

    public static boolean m2657a(Object[] objArr, Object[] objArr2) {
