...
public class MenuBuilder implements Menu {
    ...
    private boolean dispatchSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        while (it.hasNext()) {
            ...
            if (menuPresenter == null) {
                ...
                z = !z ? menuPresenter.onSubMenuSelected(subMenuBuilder) : z;
            }
        }
        return z;
    }
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2 = true;
        if (!(z && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0126R.bool.abs__config_showMenuShortcutsWhenKeyboardPresent))) {
            z2 = false;
        }
