...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.SherlockActionMode, i, 0);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0126R.layout.abs__action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode actionMode) {
        if (this.mClose == null) {
            this.mClose = (NineLinearLayout) LayoutInflater.from(this.mContext).inflate(C0126R.layout.abs__action_mode_close_item, this, false);
            addView(this.mClose);
        } else if (this.mClose.getParent() == null) {
            addView(this.mClose);
        }
        this.mClose.findViewById(C0126R.id.abs__action_mode_close_button).setOnClickListener(new OnClickListener() {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCustomView != null) {
            positionChild(this.mCustomView, i5, paddingTop, paddingTop2);
        }
        i5 = (i3 - i) - getPaddingRight();
        if (this.mMenuView != null) {
            positionChildInverse(this.mMenuView, i5, paddingTop, paddingTop2);
        }
    }
