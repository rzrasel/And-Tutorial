...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal sAnimations = new C01321();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal sDelayedAnims = new C01343();
    private static final ThreadLocal sEndingAnims = new C01354();
    private static long sFrameDelay = 10;
    private static final ThreadLocal sPendingAnimations = new C01332();
    private static final ThreadLocal sReadyAnims = new C01365();
    ...
    final class C01321 extends ThreadLocal {
        C01321() {
        }
    ...
    final class C01332 extends ThreadLocal {
        C01332() {
        }
    ...
    final class C01343 extends ThreadLocal {
        C01343() {
        }
    ...
    final class C01354 extends ThreadLocal {
        C01354() {
        }
    ...
    final class C01365 extends ThreadLocal {
        C01365() {
        }
    ...
    class AnimationHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (arrayList2.size() > 0) {
                for (size3 = 0; size3 < arrayList2.size(); size3++) {
                    ((ValueAnimator) arrayList2.get(size3)).endAnimation();
                }
                arrayList2.clear();
            }
            if (obj == null) {
