    ...
    private Method getPropertyFunction(Class cls, String str, Class cls2) {
        ...
        if (cls2 == null) {
            try {
                ...
                cls.getSimpleName() + " - Couldn't find no-arg method for property " + this.mPropertyName + ": " + e;
                return null;
            }
        }
        ...
        "Couldn't find " + str + "ter property " + this.mPropertyName + " for " + cls.getSimpleName() + " with value type " + this.mValueType;
        return method;
    }
