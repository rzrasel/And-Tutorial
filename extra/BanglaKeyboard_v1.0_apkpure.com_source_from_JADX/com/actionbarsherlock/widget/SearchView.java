...
import android.support.v4.widget.C0105d;
...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private C0105d mSuggestionsAdapter;
    ...
    class C01634 implements OnFocusChangeListener {
        C01634() {
        }
    ...
    class C01645 implements OnLayoutChangeListener {
        C01645() {
        }
    ...
    class C01656 implements OnGlobalLayoutListener {
        C01656() {
        }
    ...
    class C01667 implements OnClickListener {
        C01667() {
        }
    ...
    class C01678 implements OnKeyListener {
        C01678() {
        }
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            ...
            if (SearchView.this.mQueryTextView.isEmpty() || !C0092r.m476b(keyEvent)) {
                return SearchView.DBG;
            }
    ...
    class C01689 implements OnEditorActionListener {
        C01689() {
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mShowImeRunnable = new C01601();
        this.mUpdateDrawableStateRunnable = new C01612();
        this.mReleaseCursorRunnable = new C01623();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01667();
        this.mTextKeyListener = new C01678();
        this.mOnEditorActionListener = new C01689();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0126R.layout.abs__search_view, this, true);
        this.mSearchButton = findViewById(C0126R.id.abs__search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0126R.id.abs__search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0126R.id.abs__search_edit_frame);
        this.mSearchPlate = findViewById(C0126R.id.abs__search_plate);
        this.mSubmitArea = findViewById(C0126R.id.abs__submit_area);
        this.mSubmitButton = findViewById(C0126R.id.abs__search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0126R.id.abs__search_close_btn);
        this.mVoiceButton = findViewById(C0126R.id.abs__search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0126R.id.abs__search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C01634());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.SherlockSearchView, 0, 0);
        ...
        obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.SherlockView, 0, 0);
        ...
        if (this.mDropDownAnchor != null) {
            if (VERSION.SDK_INT >= 11) {
                this.mDropDownAnchor.addOnLayoutChangeListener(new C01645());
            } else {
                this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01656());
            }
        }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                dimensionPixelSize = resources.getDimensionPixelSize(C0126R.dimen.abs__dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0126R.dimen.abs__dropdownitem_icon_width);
            } else {
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0126R.dimen.abs__search_view_preferred_width);
    }

    private int getSearchIconId() {
        TypedValue typedValue = new TypedValue();
        getContext().getTheme().resolveAttribute(C0126R.attr.searchViewSearchIcon, typedValue, true);
    ...
    private boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable == null || this.mSuggestionsAdapter == null || keyEvent.getAction() != 0 || !C0092r.m476b(keyEvent)) {
            return DBG;
        }
        if (i == 66 || i == 84 || i == 61) {
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (inputType | Menu.CATEGORY_CONTAINER) | 524288;
            }
        }
    ...
    public C0105d getSuggestionsAdapter() {
    ...
    public void setSuggestionsAdapter(C0105d c0105d) {
        this.mSuggestionsAdapter = c0105d;
        this.mQueryTextView.setAdapter(this.mSuggestionsAdapter);
    }
}
