...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01571 extends DataSetObserver {
        C01571() {
        }
    ...
    class C01593 extends DataSetObserver {
        C01593() {
        }
            ...
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0126R.id.abs__list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0126R.layout.abs__activity_chooser_view_list_item, viewGroup, false);
                    }
                ...
                case 1:
                    ...
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0126R.layout.abs__activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0126R.id.abs__title)).setText(ActivityChooserView.this.mContext.getString(C0126R.string.abs__activity_chooser_view_see_all));
                    return view;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C01571();
        this.mOnGlobalLayoutListener = new C01582();
        ...
        LayoutInflater.from(this.mContext).inflate(C0126R.layout.abs__activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (IcsLinearLayout) findViewById(C0126R.id.abs__activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0126R.id.abs__default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0126R.id.abs__image);
        this.mExpandActivityOverflowButton = (FrameLayout) findViewById(C0126R.id.abs__expand_activities_button);
        this.mExpandActivityOverflowButton.setOnClickListener(this.mCallbacks);
        this.mExpandActivityOverflowButtonImage = (ImageView) this.mExpandActivityOverflowButton.findViewById(C0126R.id.abs__image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(drawable);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C01593());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0126R.dimen.abs__config_prefDialogWidth));
    }
    ...
    private void showPopupUnchecked(int i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            listPopupWindow.getListView().setContentDescription(this.mContext.getString(C0126R.string.abs__activitychooserview_choose_application));
        }
    }
