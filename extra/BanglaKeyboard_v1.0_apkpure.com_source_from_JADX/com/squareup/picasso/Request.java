...
public final class Request {
    ...
    public final class Builder {
        ...
        public final Builder transform(List list) {
            if (list == null) {
    ...
    private Request(Uri uri, int i, String str, List list, int i2, int i3, boolean z, boolean z2, boolean z3, float f, float f2, float f3, boolean z4, Config config, Priority priority) {
        this.uri = uri;
        this.resourceId = i;
        this.stableKey = str;
        if (list == null) {
