...
public class Picasso {
    static final Handler HANDLER = new C05991(Looper.getMainLooper());
    ...
    final class C05991 extends Handler {
        C05991(Looper looper) {
            super(looper);
        }
    ...
    public interface RequestTransformer {
        public static final RequestTransformer IDENTITY = new C06011();

        final class C06011 implements RequestTransformer {
            C06011() {
            }
    ...
    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, List list, Stats stats, Config config, boolean z, boolean z2) {
